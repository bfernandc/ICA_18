...
apellido= "FERNANDEZ"
nombre= "SAMARA"
minombre= paste(nombre,apellido,"")
minombre
...
rm(apellido,factornombre,minombre,nombre, vectorminombre)
rm(numero1)
...
sesentanumeros=1:60
matriz=matrix(sesentanumeros,nrow = 20,ncol=3)
matriz
...
########No entendí        #########################14) sustituye en un solo comando todos los nombres de base_de_datos por "nombres_futuros"

sustituir=factor(base_de_datos, label=nombres_futuros)
sustituir
...
input="C:\\Users\\ASUS\\Desktop\\datos"
...
setwd("C:\\Users\\ASUS\\Desktop\\datos\\tarea")

nombredebase="BaseMunFW.dta"

base_numero_uno=read.dta13(nombredebase)
